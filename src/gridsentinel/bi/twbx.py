...
<workbook source-build="2024.1.0" source-platform="mac" version="18.1" xml:base="">
  <preferences />
  <datasources>
{datasources}
  </datasources>
  <_.fcp.AnimationOnByDefault.true...style>
    <style>
  ...
  <windows source-height="50">
    <window class="worksheet" maximized="true" name="Top incidents">
      <viewpoints>
        <viewpoint name="Top incidents" />
      </viewpoints>
    </window>
  </windows>
  <thumbnails />
